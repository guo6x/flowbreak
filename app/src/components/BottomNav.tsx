...
export default function BottomNav() {
  ...
  if (location.pathname === '/rest') return null;

  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-300/40 z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 8px)' }}>
